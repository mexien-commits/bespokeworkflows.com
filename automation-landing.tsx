  ...
  const projects = [
    {
      ...
      description: "Randomises videos for users to watch based on time available",
      icon: <Sparkles className="w-6 h-6" />
    },
    {
      name: "Interview Prep 360",
      url: "http://www.interviewprep360.com",
      description: "Comprehensive interview preparation automation powered by AI. Users input the company name, job title and industry then AI generates a tailored guide to help interviewees prepare for the role",
      icon: <Code className="w-6 h-6" />
    },
    {
      name: "TaskHarbor",
      url: "https://taskharbor.co",
      description: "Task management and daily reflection",
